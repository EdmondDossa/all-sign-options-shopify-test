<template>
    <div id="aso-frontend-app" class="aso-relative aso-flex aso-flex-col lg:aso-flex-row-reverse aso-w-full aso-h-[100vh]">

        <div class="aso-w-full lg:aso-w-[92%] aso-h-[54%] lg:aso-h-full aso-flex aso-flex-col">
            <div class="aso-w-full aso-h-[9%] lg:aso-h-[10%] aso-bg-gradient-to-r aso-from-[#016464] aso-to-[#038888] aso-flex aso-items-center aso-justify-between">
                ...
                <div v-show="!isLoaded" class="aso-flex aso-w-1/3 aso-full-center aso-space-x-4">
                    ...
                    <div class="aso-flex aso-full-center aso-space-x-4">
                        ...
                        <div class="aso-flex aso-justify-between aso-items-center aso-text-white aso-space-x-2">
                            <span @click="redo" class="aso-w-fit aso-h-fit aso-flex aso-full-center aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-p-2 aso-rounded-full aso-bg-transparent hover:aso-bg-[#016464] aso-base-animation">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="aso-w-4 aso-h-4 lg:aso-w-5 lg:aso-h-5">
            ...
            <div class="aso-relative aso-w-full aso-h-[91%] lg:aso-h-[90%] aso-flex aso-flex-col aso-items-center aso-bg-[#f5f5f5]">
                ...
                <div id="aso-editButtons" class="aso-absolute aso-bottom-0 aso-w-full aso-h-[10%]  aso-hidden lg:aso-flex aso-full-center aso-bg-white aso-space-x-4">
                    ...
                    <div class="aso-w-1/3 aso-h-full aso-flex aso-justify-end">
                        <div v-show="!isLoaded" class="aso-hidden lg:aso-flex aso-full-center aso-w-[40%] aso-h-full aso-bg-[#FFBC3C] aso-text-white aso-font-semibold aso-p-2 aso-px-3 aso-base-animation">{{props.config.data.settings.languageImages.visualizer.textButtonFinish}}</div>
                    </div>
                </div>
            </div>
        </div>

        <div id="aso-optionsButtons-container" class="aso-relative aso-w-full aso-h-[8%] lg:aso-w-[8%] lg:aso-h-full aso-p-0 aso-flex aso-flex-col aso-shadow-lg aso-bg-black">
            ...
            <div v-show="!isLoaded" class="aso-w-full aso-h-full aso-flex lg:aso-flex-col aso-items-center lg:aso-space-y-4 aso-py-4 aso-overflow-auto no-scrollbar">
                <div @click="showOptions('material')" class="aso-w-[80%] aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-gradient-to-b aso-from-[#1B3448] aso-to-[#1F2226] hover:aso-from-[#1F2226] hover:aso-to-[#1B3448] aso-text-white aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation">
                ...
                <div v-if="materialType == 'advance'" v-for="(component, id) in currentMaterial.data" class="aso-w-[80%]" >
                    <div @click="showOptions('component', component)" class="aso-w-full aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-gradient-to-b aso-from-[#1B3448] aso-to-[#1F2226] hover:aso-from-[#1F2226] hover:aso-to-[#1B3448] aso-text-white aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation">
                ...
                <div v-if="sizees.length > 0 || customSizeActive && materialType == 'simple'" @click="showOptions('size')" class="aso-w-[80%] aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-gradient-to-b aso-from-[#1B3448] aso-to-[#1F2226] hover:aso-from-[#1F2226] hover:aso-to-[#1B3448] aso-text-white aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation">
                ...
                <div v-if="shapees.length > 0 && materialType == 'simple'" @click="showOptions('shape')" class="aso-w-[80%] aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-gradient-to-b aso-from-[#1B3448] aso-to-[#1F2226] hover:aso-from-[#1F2226] hover:aso-to-[#1B3448] aso-text-white aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation">
                    <svg class="aso-w-6 aso-h-6" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="mdi:shape">
                ...
                <div v-if="fixinggs.length > 0" @click="showOptions('fixing-methode')" class="aso-w-[80%] aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-gradient-to-b aso-from-[#1B3448] aso-to-[#1F2226] hover:aso-from-[#1F2226] hover:aso-to-[#1B3448] aso-text-white aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation">
                    ...
                    <div class="aso-text-[10px] lg:aso-text-[13px] aso-font-medium aso-text-center">
                        {{props.config.data.settings.languageImages.visualizer.textFixingMethods}}
                    </div>
                </div>

                <div v-if="borderrs.length > 0 && materialType == 'simple'" @click="showOptions('border')" class="aso-w-[80%] aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-gradient-to-b aso-from-[#1B3448] aso-to-[#1F2226] hover:aso-from-[#1F2226] hover:aso-to-[#1B3448] aso-text-white aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation">
                ...
                <div v-if="colorrs.length > 0" @click="showOptions('color')" class="aso-w-[80%] aso-h-fit aso-flex aso-flex-col aso-full-center aso-space-y-1 aso-bg-gradient-to-b aso-from-[#1B3448] aso-to-[#1F2226] hover:aso-from-[#1F2226] hover:aso-to-[#1B3448] aso-text-white aso-px-4 aso-py-1 aso-rounded-lg aso-base-animation">
                    <svg class="aso-w-6 aso-h-6" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="aso-w-full aso-h-[32%] lg:aso-w-fit lg:aso-h-fit">
            ...
            <div class="aso-w-full aso-flex lg:aso-hidden aso-h-[15%] aso-bg-red-400">
                ...
                <div class="aso-w-1/2 aso-h-full aso-flex aso-full-center aso-bg-[#016464] aso-text-white hover:aso-bg-[#029797]">Terminer</div>
            </div>
        </div>
