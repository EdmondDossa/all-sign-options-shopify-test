        ...
        <div class="aso-relative aso-flex aso-w-full aso-h-full">
            <div class="aso-w-full lg:aso-w-[92%] aso-h-full aso-flex aso-flex-col">
                <div :class="`aso-w-full aso-h-[7%] lg:aso-h-[10%] aso-bg-[${configColors.backgroundColorHeader}] aso-text-[${configColors.textColorContentHeader}] aso-flex aso-items-center aso-justify-between`">
                    ...
                    <div v-show="!isLoaded" class="aso-flex aso-w-1/3 aso-justify-start aso-pl-3 aso-text-base lg:aso-text-2xl aso-font-bold aso-text-center">
                    ...
                    <div v-show="!isLoaded" class="aso-flex aso-w-1/3 aso-justify-center aso-items-center aso-space-x-4">
                        ...
                        <div class="aso-flex aso-justify-center aso-items-center aso-space-x-4">
                            <div class="aso-flex aso-full-center aso-space-x-2">
                                <span @click="undo" class="aso-w-fit aso-h-fit aso-flex aso-full-center aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-p-2 aso-rounded-full aso-base-animation aso-cursor-pointer">
                            ...
                            <div class="aso-flex aso-full-center aso-space-x-2">
                                <span @click="redo" class="aso-w-fit aso-h-fit aso-flex aso-full-center aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-p-2 aso-rounded-full aso-base-animation aso-cursor-pointer">
                    ...
                    <div v-show="!isLoaded" id="aso-price" class="aso-flex aso-w-1/3 aso-justify-end aso-pr-2 aso-items-center aso-space-x-2">
                ...
                <div :class="`aso-relative aso-w-full aso-h-[93%] lg:aso-h-[90%] aso-flex aso-flex-col aso-items-center aso-bg-[${configColors.canvasBackgroundColor}]`">
                    ...
                    <div id="aso-optionsButtons-container" :class="`aso-w-full aso-relative aso-px-10 lg:aso-px-2 lg:aso-w-[60%] aso-h-[8%] lg:aso-h-[15%] aso-flex aso-full-center aso-bg-[${configColors.backgroundColorHeader}] aso-text-[${configColors.textColorContentHeader}] lg:aso-bg-transparent`">
                        ...
                        <div v-show="!isLoaded" id="aso-options-buttons" class="aso-scrollDiv aso-flex aso-items-center aso-w-full aso-h-fit aso-p-0.5 aso-overflow-x-auto aso-scrollBar">
                            ...
                            <div v-if="showScrollButton">
                                <div @click="ScrollLeft('aso-options-buttons')" :class="`aso-absolute aso-top-[50%] aso-left-0 lg:aso-translate-x-[-80%] aso-translate-y-[-50%] aso-w-fit aso-h-[90%] aso-bg-[${configColors.backgroundColorHeader}] aso-text-[${configColors.textColorContentHeader}] aso-flex aso-full-center aso-rounded-md aso-px-2 aso-cursor-pointer`">
                                ...
                                <div @click="ScrollRight('aso-options-buttons')" :class="`aso-absolute aso-top-[50%] aso-right-0 lg:aso-translate-x-[80%] aso-translate-y-[-50%] aso-w-fit aso-h-[90%] aso-bg-[${configColors.backgroundColorHeader}] aso-text-[${configColors.textColorContentHeader}] aso-flex aso-full-center aso-rounded-md aso-px-2 aso-cursor-pointer`">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="aso-w-7 aso-h-7">
            ...
            <div :class="`aso-absolute aso-top-[50%] lg:aso-top-0 aso-translate-y-[-70%] lg:aso-translate-y-0 aso-right-4 lg:aso-right-0 lg:aso-relative aso-w-[8%] aso-h-fit lg:aso-h-full aso-p-2 lg:aso-p-0 aso-flex aso-flex-col aso-bg-[${configColors.backgroundColorContentSide}] aso-text-[${configColors.textColorContentSideMenu}] aso-rounded-lg lg:aso-rounded-none aso-shadow-lg`">
                ...
                <div v-show="!isLoaded" class="lg:aso-h-[90%] aso-flex aso-flex-col aso-full-center aso-space-y-4">
                    <div class="aso-flex aso-flex-col aso-full-center aso-space-y-2">
                        <span @click="showConfigRender()" :class="`aso-flex aso-full-center aso-rounded-full aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-p-2 lg:aso-p-3 aso-bg-[${configColors.backgroundButton}] hover:aso-bg-[${configColors.backgroundColorHoverButton}] aso-text-[${configColors.textColorButton}] hover:aso-text-[${configColors.textColorHoverButton}] aso-base-animation aso-cursor-pointer`">
                    ...
                    <div class="aso-flex aso-flex-col aso-full-center aso-space-y-2">
                        <span :class="`aso-flex aso-full-center aso-rounded-full aso-shadow-[1px_1px_7px_1px_rgba(0,0,0,0.1)] aso-p-2 lg:aso-p-3 aso-bg-[${configColors.backgroundColorButtonHelp}] hover:aso-bg-[${configColors.backgroundColorHoverButtonHelp}] aso-text-[${configColors.textColorButtonHelp}] hover:aso-text-[${configColors.textColorHoverButtonHelp}] aso-base-animation aso-cursor-pointer`">
