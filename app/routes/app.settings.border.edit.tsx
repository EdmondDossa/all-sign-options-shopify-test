...
export default function SettingShapeEdit() {
  ...
  let border = borders.find(curr => curr.value == id);
  const [formData, setFormData] = useState<BorderType>((border as BorderType));
...
export const action = async ({ request, params }: ActionFunctionArgs) => {
  ...
  let border: BorderType = submission.value as BorderType;
