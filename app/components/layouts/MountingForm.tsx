...
interface Props {
  ...
  onChange?: (mounting: MountingType) => void;
  onSubmit: (mounting: MountingType) => void;
  onClose: () => void;
}
...
export default function MountingForm({
  mounting,
  currencySymbol,
  onChange,
  onSubmit,
  ...
  const defaultSize: MountingType | any = isEditing
    ? mounting
    : {
        id: null,
        label: "",
  ...
  const onInternalSubmit = (data: MountingType) => {
    try {
      onSubmit(data);
    } catch (e) {
        ...
        <InlineStack gap="300" align="space-between">
          <Box padding="300" background="bg-surface">
            <Text as="p" variant="headingMd">
              Mountings <NextLtrIcon width={6} height={10} />{" "}
              {isEditing ? "Edit Mounting" : "Add new Mounting"}
            </Text>
          </Box>
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <UploaderLayout
                        ...
                        helperText="Upload an image to display the mounting. Adding an image will replace the preview color."
          ...
          <Box paddingInline="300" paddingBlock="200">
            <InlineStack align="end" gap="600">
              ...
              <button
                ...
                type="submit" // Type submit pour activer handleSubmit
              >
                <Box paddingInline="1000">
